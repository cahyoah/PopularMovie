...
public class ReviewLoader extends AsyncTaskLoader<ArrayList<Review>> {
    ...
    public ReviewLoader(final Context context, String idFilm) {
        super(context);
        onContentChanged();
        this.idFilm= idFilm;
    }
    ...
    @Override
    public void deliverResult(final ArrayList<Review> data) {
        mData = data;
        hasResult = true;
    ...
    public ArrayList<Review> loadInBackground() {
        ...
        String url = "http://api.themoviedb.org/3/movie/"+idFilm+"/reviews?api_key=f2b2a982528076cddeafc7b7f49e83b3";
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    for (int i = 0 ; i < list.length() ; i++){
                        JSONObject ReviewObject= list.getJSONObject(i);
    ...
    protected void onReleaseResources(ArrayList<Review> data) {
        //nothing to do.
    }
