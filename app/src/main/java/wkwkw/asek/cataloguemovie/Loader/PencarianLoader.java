...
public class PencarianLoader extends AsyncTaskLoader<ArrayList<Film>> {
    private ArrayList<Film> mData;
    public boolean hasResult = false;

    public PencarianLoader(final Context context) {
        super(context);
        onContentChanged();
    }
    ...
    public ArrayList<Film> loadInBackground() {
        ...
        String url = null;
        if(getId()==1){
            //url = "https://api.themoviedb.org/3/movie/now_playing?api_key=f2b2a982528076cddeafc7b7f49e83b3&language=en-US";
            url = "https://api.themoviedb.org/3/movie/popular?api_key=f2b2a982528076cddeafc7b7f49e83b3&language=en-US";

        }else if(getId()==2){
         //   url = "https://api.themoviedb.org/3/movie/upcoming?api_key=f2b2a982528076cddeafc7b7f49e83b3&language=en-US";
